function createPetal() {
    const petalsContainer = document.getElementById('petals-container4');
    if (!petalsContainer) {
        console.error('El contenedor de pétalos no se encontró');
        return; // Si el contenedor no existe, no se ejecuta la función
    }
